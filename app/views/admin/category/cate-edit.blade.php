                                                ...
                                                <div class="row">
                                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                        <div class="form-group">
                                                            <input name="cate_name" type="text" class="form-control" placeholder="Tên Loại" value="{{$cate->cate_name}}">
                                                        </div>
                                                        <div class="form-group">
                                                            <input name="type_detail" type="text" class="form-control" placeholder="Chi Tiết Loại"  value="{{$cate->type_detail}}">
                                                        </div>
                                                    ...
                                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                        <div class="form-group alert-up-pd">
                                                            ...
                                                            <button class="file-upload-btn"  type="button" onclick="$('.file-upload-input').trigger( 'click' )">Thêm Ảnh</button>
                                                                <div style="width: 100%;">
                                                                    <div class="img-av">
                                                                        <img    src="{{PUBLIC_URL.$cate->cate_avatar}}" alt="">
                                                                    </div>
