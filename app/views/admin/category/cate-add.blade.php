                                                ...
                                                <div class="row">
                                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                        <div class="form-group">
                                                            <input name="cate_name" type="text" class="form-control" value="{{isset($_POST['cate_name']) ?$_POST['cate_name'] : ""}}" placeholder="Tên">
                                                        </div>
                                                        <div class="form-group">
                                                            <input name="type_detail" type="text" class="form-control" value="{{isset($_POST['type_detail']) ?$_POST['type_detail'] : ""}}" placeholder="Chi Tiết">
                                                        </div>
