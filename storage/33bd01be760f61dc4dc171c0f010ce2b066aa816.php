...
<head>
  ...
  ================================================== -->
    ...
    <link rel="stylesheet" href="<?php echo e(LOGIN_ASSET_URL); ?>css\login-style.css">
...
<body>
                    ...
                    <div class="brand-col">
                        <div class="headline">
                            ...
                            <div class="brand-logo">
                                <a href="<?php echo e(BASE_URL); ?>"><img src="<?php echo e(LOGIN_ASSET_URL); ?>images\karma.png" width="200" alt="brand-logo"></a>
                            </div>
                            <!-- ./brand-logo -->
                        ...
                        <div class="authfy-panel panel-signup text-center">
                            <div class="row">
                                <div class="col-xs-12 col-sm-12">
                                    ...
                                    <form name="signupForm" class="signupForm" action="<?php echo e(BASE_URL.'registr'); ?>" method="POST">
                                        <div class="form-group">
    ...
    <script src="<?php echo e(LOGIN_ASSET_URL); ?>js\jquery-2.2.4.min.js"></script>

    <!-- for Bootstrap js -->
    <script src="<?php echo e(LOGIN_ASSET_URL); ?>js\bootstrap.min.js"></script>

    <!-- Custom js-->
    <script src="<?php echo e(LOGIN_ASSET_URL); ?>js\custom.js"></script>

</body>

</html><?php /**PATH C:\xampp\htdocs\php2\asm_final\mvc\app\views/auth/login.blade.php ENDPATH**/ ?>